...
public class DailyCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (currentTime - lastClaim < cooldownMillis) {
            ...
            player.sendMessage(plugin.getConfigManager().getEconomyConfig().getString("daily-reward.already-claimed", "You can claim again in %hours% hours and %minutes% minutes.")
        ...
        player.sendMessage(plugin.getConfigManager().getEconomyConfig().getString("daily-reward.claimed", "Daily reward claimed! You received $%amount%.")
